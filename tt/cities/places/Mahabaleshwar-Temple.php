            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Mahabaleshwar Temple</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/compressed/attractions/attr_2344.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/compressed/3425.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/MahabaleshwarTempleinGokarna_20200116125834.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Located at a distance of 6 km from the city of Mahabaleshwar; Mahabaleshwar temple is an ancient shrine and an ideal example of the Maratha heritage. Popularly known as the Mahabali, the temple is flocked by tourists and devotees throughout the year to bask in the serenity and tranquillity offered here. The temple is extremely popular among the Hindus, as Lord Shiva is the presiding deity here. Set up amidst the hilly terrain, this picturesque temple glorifies the Maratha Empire and its rule during the 16th century.
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Timing: </strong>6:00 AM - 7:00 PM</h5></li>
                            <br>
                            ...
                            <script>
                              function valuesender()
                              {
                                ...
                                var place='MAHABALESHWAR TEMPLE';
