            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Anjuna Beach</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.tourmyindia.com/states/goa/image/anjuna-beach-banner.webp" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://static.india.com/wp-content/uploads/2020/10/goa1200.jpg?impolicy=Medium_Resize&w=1200&h=800" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.whereandwhen.net/site/images/illustration/anjuna-beach.jpg" alt="Third slide">
                                  </div>
                                </div>
