            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://ds393qgzrxwzn.cloudfront.net/resize/m500x500/cat1/img/images/0/mReclRchOu.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://images.unsplash.com/photo-1590765759804-0b2b579820b3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8b290eXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://image3.mouthshut.com/images/imagesp/925004353s.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Nestled amidst Nilgiri hills, Ooty, also known as Udagamandalam, is a hill station in Tamil Nadu which serves as a top-rated tourist destination. Once regarded as the summer headquarters of the East India Company, the Queen of the hills is a picturesque getaway.
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <hr>
                            <ul>
                            <li><h5><strong>Weather: </strong>19° C</h5></li>
                            <br>
                            <li><h5><strong>Timing: </strong>9:00 AM - 5:30 PM</h5></li>
                            <br>
