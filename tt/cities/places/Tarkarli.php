            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Tarkarli</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://media-cdn.tripadvisor.com/media/photo-s/07/dc/cb/21/devbagh-beach.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Tarkarli_Photo_by_Sandeep_Wairkar.jpg/1200px-Tarkarli_Photo_by_Sandeep_Wairkar.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://static2.tripoto.com/media/filter/l/img/371512/TripDocument/1493902235_screenshot_2017_05_04_17_03_25_1.png" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Tarkarli is famous for its long and narrow stretch of beach, with its pristine water, white sand, and of course Singhudurg, Maharashtra's popular sea fort.
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <hr>
                            <ul>
                            <li><h5><strong>Weather: </strong>27 °C</h5></li>
                            <br>
                            <li><h5><strong>Timing: </strong>10:00 AM - 11:00 PM</h5></li>
                            <br>
