            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">ISKCON Temple</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/4140_20190823122408.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://holidify.com/images/attr_wiki/compressed/attr_wiki_216.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://holidify.com/images/attr_wiki/compressed/attr_wiki_214.jpg" alt="Third slide">
                                  </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Timing: </strong>4:15 AM - 8:30 PM</h5></li>
                            <br>
