            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Periyar National Park</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://images.thrillophilia.com/image/upload/s--QRUEAHAg--/c_fill,g_center,h_642,q_auto,w_1280/f_auto,fl_strip_profile/v1/images/photos/000/146/429/original/1551426648_periyar-head-194.jpeg.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.indiatravel.com/wp-content/uploads/2020/06/periyar-national-park-india.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.packagetourkerala.com/wp-content/uploads/2019/04/Kesari-Tours-Periyar-Wildlife-Sanctuary-7-1024x640.jpg" alt="Third slide">
                                  </div>
                                </div>
                    ...
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <script>
                              ...
                              {
                                var city='KERALA';
                                var place='PERIYAR NATIONAL PARK';
