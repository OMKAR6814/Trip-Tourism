            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Tapola</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/tapolaminikashmirtourismentryfeetimingsholidaysreviewsheader_20200713151326.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/compressed/attractions/attr_2114.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/compressed/attractions/attr_2419.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Situated in Mahabaleshwar, Tapola is a satellite village famed as the 'Mini Kashmir'. It has some of the most picturesque scenic beauty which makes it an ideal destination for a back to nature experience. There are many unknown forts in the dense forest around the lake in Tapola like Vasota and Jaygad, which make for an adventure in its own right.

Jungle treks, especially the trek to Vasota Fort is a thrilling activity in Tapola and is fast gaining popularity amongst tourists. You can also explore the many nameless islands which lie in this vast 90-kilometre reservoir, or boat in Shivsagar Lake as well. With a plethora of fascinating things to do, Tapola is the perfect weekend getaway.
                        </div>
                    </div>
                </div>
