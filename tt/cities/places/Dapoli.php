            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Dapoli</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.nativeplanet.com/img/2017/08/22-1503397330-5alsocover.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://cdn-akkkh.nitrocdn.com/zKfWbvuWdqLOmZiIfyoTDvNeRxGMgSdC/assets/static/optimized/rev-86aa1ab/wp-content/uploads/2021/01/Kolthare-beach-1.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://5.imimg.com/data5/OL/WE/MY-13903575/dapoli-500x500.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Dapoli, situated 215km away from Mumbai is popular tourist destination that serves the needs of all kinds of travelers. It is known as mini-Mahabaleshwar of Maharashtra owing to its cool climate throughout the year. It is located in the Ratnagiri district and is a famous Konkan hill station.

                            It is a small town packed with attractions from historic forts, temples, pristine beaches and lush vegetation surrounding all of it, making it a recent favorite for weekend destination travelers.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Timing: </strong>10:00 AM - 11:30 PM</h5></li>
                            <br>
