            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">St. Paul's Cathedral Kolkata</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/38293940552_cd3e78de29_k_20171214175140.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://holidify.com/images/attr_wiki/compressed/attr_wiki_2290.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://holidify.com/images/attr_wiki/compressed/attr_wiki_2295.jpg" alt="Third slide">
                                  </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Timing: </strong>9:00 AM - 12:00 PM, 3:00 PM to 6:00 PM</h5></li>
                            <br>
                            ...
                            <script>
                              ...
                              {
                                var city='KOLKATA';
                                var place='ST.PAULS CATHEDRAL KOLKATA';
