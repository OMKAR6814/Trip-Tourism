            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Baga Beach</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.tripsavvy.com/thmb/x_iOUk0OrA5J_1kbzxJZbLZlQfs=/1913x1435/smart/filters:no_upscale()/GettyImages-903398436-5c612e4a46e0fb00017dd31f.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://i1.wp.com/www.paisawapas.com/blog/wp-content/uploads/2017/04/baga-beach-goa.jpg?fit=850%2C630&ssl=1" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.picnicwale.com/attractions/assets/sightseeing/goa-baga-beach.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">Baga a seaside town in Bardez, Goa, India. It comes under the jurisdiction of Calangute, which is 2 km south. Baga is known for its popular beach and Baga Creek. It is visited by thousands of tourists annually.Baga Beach is a popular beach and tourist destination in North Goa. Baga is located at the north end of the contiguous beach stretch that starts from Sinquerim, Candolim, leads to Calangute, and then to Baga.
Dolphins can be located at around 1–2 km from the shoreline Parasailing in Baga Beach The beach contains rows of shacks and fishing boats, and at high tide the beach is narrow.
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Timing: </strong>11:00 AM - 10.00 PM</h5></li>
                            <br>
                            ...
                            <hr>
                            <a href="/tt/cities/places/reservation.php" onclick="valuesender()"><h4 class="reserve">Reserve Now!</h4></a>

                            <script>
                              function valuesender()
                              {
                                var city='GOA';
                                var place='BAGA BEACH';
