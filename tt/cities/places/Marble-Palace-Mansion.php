            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="adventure-detail-card mb-3">
                        <div>
                            <h1 id="adventure-name">Marble Palace Mansion</h1>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/compressed/5717.jpg" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/1024px-Marble_Palace_Back_20190618211620.jpg" alt="Second slide">
                                  </div>
                                  <div class="carousel-item">
                                    <img class="d-block w-100" src="https://www.holidify.com/images/cmsuploads/compressed/1024px-Marble_Palace_from_Marble_palace_Zoo_20190618211621.jpg" alt="Third slide">
                                  </div>
                                </div>
                        ...
                        <hr>
                        <h4>Description</h4>
                        <div id="adventure-content">The Marble palace near the Chorbagan in North Kolkata built in 1835 by Rajendra Mallick is famed for its art collection of masterpieces by Reuben and paintings by various renowned international artists such as Reynolds, Van Gogh and Rembrandt.
                ...
                <div class="col-lg-4">
                    <div class="">
                        <div id="reservation-panel-sold-out" >
                            ...
                            <br>
                            <li><h5><strong>Time Required: </strong>1 hours</h5></li>
                            <br>
                            ...
                            <script>
                              ...
                              {
                                var city='KOLKATA';
                                var place='MARBLE PALACE MANSION';
